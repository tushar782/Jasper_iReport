...
$query = '(SELECT RENEWALHISTORY."RENEWAL_DATE", RENEWALHISTORY."AC_RENEWAL_COUNTER", RENEWALHISTORY."AC_ACNOTYPE", RENEWALHISTORY."AC_TYPE",
RENEWALHISTORY."AC_NO" , RENEWALHISTORY."NEW_EXPIRY_DATE" , SCHEMAST."S_NAME",LNMASTER."AC_NAME" , GUARANTERDETAILS."AC_ACNOTYPE" G_ACNOTYPE,
GUARANTERDETAILS."AC_TYPE" G_ACTYPE, GUARANTERDETAILS."AC_NO" G_ACNO, GUARANTERDETAILS."AC_NAME" GUARENTER_NAME , LNMASTER."AC_SANCTION_AMOUNT",
...
WHERE (CAST(LNMASTER."AC_OPDATE" AS DATE) IS NULL OR CAST(LNMASTER."AC_OPDATE" AS DATE) <= CAST('.$START_DATE.'AS DATE))
