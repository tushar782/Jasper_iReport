...
$dateformate = "'DD/MM/YYYY'";
 ...
 $query = ' SELECT  "AC_NAME","SUBMISSION_DATE" , "NOMINEE_RELATION" , "ARTICLE_NAME" ,"TOTAL_WEIGHT_GMS" , "CLEAR_WEIGHT_GMS", "AC_SECURITY_AMT"
           "ac_sanction_amount", "RATE" ,"MARGIN" FROM GOLDSILVER   
            LEFT OUTER  JOIN LNMASTER ON CAST(GOLDSILVER."AC_NO" AS INTEGER) = LNMASTER."AC_NO"
            LEFT OUTER JOIN VWALLMASTER ON LNMASTER."BANKACNO" = VWALLMASTER."ac_no"
            ...
            AND CAST(LNMASTER."AC_OPDATE" AS DATE) <= CAST('.$END_DATE.' AS DATE)';
